...
## Goal Number
If the total successes which **meet or exceed** the [[Dice Rolls#Difficulty|difficulty]] reach this number, the extended action is completed (and successful). 
## Terminus
Expressed as a number of rolls or [[#Interval|intervals]]. If this many rolls have been made, and the [[#goal number]] has not been reached, then the Extended roll automatically fails. The character is out of time.
## Interval
