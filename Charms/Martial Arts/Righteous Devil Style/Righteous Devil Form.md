...
The first time the Righteous Devil enters this form in a fight, she may roll ([[Charisma]] + [[Presence]] + [[Essence]]) to intimidate all enemies or inspire them with an emotion of shame, guilt, or remorse as appropriate to their sins. Affected enemies take a penalty equal to the stylist’s [[Charisma]] on disengage, withdraw, or [[Traits/Abilities/Stealth]]-based actions unless they pay [[Willpower]] to resist.
...
Additionally, while in this form, the Righteous Devil can use [[Firewand|firewands]] effectively in close combat, using the butt or handle of a flame weapon to effectively bludgeon enemies. When used in this way, they are treated as medium weapon with the bashing, martial arts, and shield tags. [[Firewand|Firewands]] with an affixed bayonet instead have the lethal tag. While this use is not compatible with effects that specifically modify ranged attacks, such as the range extension of [[Blossom of Inevitable Demise]], it can still benefit from other [[Charms]] of this or other [[Staff]] or [[Spear]] compatible styles. 
