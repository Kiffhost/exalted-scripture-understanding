...
A second purchase of this Charm lets the Abyssal use it to reflexively reload weapons with the Slow tag. This makes such weapons compatible with magic that creates multiple attacks as long as she reloads for each attack.
### Whispers
When the Abyssal uses this Charm to add dice on an attack roll, she can invoke her Whispers to convert them to non-Charm successes.
