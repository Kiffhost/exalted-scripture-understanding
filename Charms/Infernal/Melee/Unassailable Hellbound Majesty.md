...
## [[Keys]]
#### Invincible Universe Emperor (Melee 5, Essence 5)
The Infernal surges with power when she successfully defends an attack with this Charm’s enhance Parry. She gains (Essence) motes, separate from her normal mote pool, and gains an additional (Essence/2, rounded up) motes at the start of each of her turns. These motes can only be spent on Charms that enhance attacks, command actions, and threaten rolls, as well as persuade rolls that are framed as direct commands. This ends if she’s hit by an attack or if she goes a round without spending these motes on an action.