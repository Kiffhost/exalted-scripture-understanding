...
Resisting this influence costs three Willpower, but it can’t be resisted by crashed enemies or trivial opponents. Characters using magic to see through illusion can resist for one Willpower instead.
### Whispers
The Abyssal may invoke her Whispers to add (Whispers) non-Charm dice on the roll.
