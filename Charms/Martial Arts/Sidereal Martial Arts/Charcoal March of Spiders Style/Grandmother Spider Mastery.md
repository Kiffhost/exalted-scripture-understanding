...
The stylist can pay a 15-mote, one-Willpower surcharge when she uses this style’s Form to gain the following benefits
- Her extra Initiative tracks can be crashed normally rather than being lost completely upon crash. The stylist only counts as being crashed for Perilous Charms and other effects if all three tracks are crashed.
