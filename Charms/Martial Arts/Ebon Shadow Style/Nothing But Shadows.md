...
When the martial artist takes a [[Traits/Abilities/Stealth]] action in combat, she may use [[Nothing But Shadows]] to apply a penalty equal to (higher of 3 or her [[Essence]]) to the opposed roll of any enemy with a lower [[Initiative]] than her, to a maximum of -5.
...
## Mastery
Every 1 that a non-trivial enemy rolls on his ([[Perception]] + [[Awareness]]) opposing the supplemented action gives the martial artist a point of [[Initiative]], up to a maximum of ([[Traits/Abilities/Stealth]]) points per activation.