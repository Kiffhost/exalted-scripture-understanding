...
With a repurchase, the Abyssal may pay a four-mote, one-Willpower surcharge to let her mount fly as if on unseen wings, up to a maximum of long range above the ground. If she uses this Charm while on the ground, she can rise two range bands, rather than one, with a reflexive move action. Once airborne, this Charm’s base effect is sufficient to maintain her elevation — she need only pay the surcharge if she wishes to make further vertical movement. If she’s already airborne, the Willpower cost is waived.
