...
### Minor
An expenditure lower than the target’s Resources rating or an inconvenient task.
### Major
An expenditure up to one dot higher than the target’s Resources rating or a serious task.
### Defining
An expenditure at least two dots higher than the target’s Resources rating or a life-changing task.
