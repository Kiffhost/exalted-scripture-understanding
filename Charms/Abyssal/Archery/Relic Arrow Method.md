...
The Abyssal can make an [[Archery]] attack without needing ammunition (including firedust). Once per scene, she can suffuse an arrow with undying hatred, adding two non-Charm dice on the [[Attack#hit roll|attack roll]].
A second purchase of this Charm lets the Abyssal use it to reflexively reload weapons with the [[Item Tags#Slow|Slow]] tag.
