...
A [[Templates/sorcery]]-capturing cord can hold a single spell. Looking at a pre-existing knot, one can determine the captured spell’s circle with a difficulty 3 ([[Intelligence]] + [[Occult]]) roll, and the specific spell with (Circle x 2) threshold successes. [[All-Encompassing Sorcerer’s Sight]] and similar [[Charms]] reveal this information automatically. Destroying the cord releases a distorted or botched version of the stored spell in a random direction.