...
# Defining Symptom
The victim’s body houses an undead monster, constantly struggling to escape. This level functions as the major symptom, but now only defining [[Intimacy|Intimacies]] can be drawn on in a Decision Point to resist the evil impulses—which can now occur every scene in place of a botch. 
# Death
