...
When the Abyssal succeeds on a profile character roll, she also learns one of her target’s negative Ties. Alternatively, a successful case scene roll also reveals a negative Tie that motivated the events being investigated, if there is one.
The Storyteller should reveal the Tie most relevant to the Abyssal’s purpose for making the roll.
