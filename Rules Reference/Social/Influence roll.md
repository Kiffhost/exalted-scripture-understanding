...
# Resisting
The base difficulty for an [[#Influence roll]] is always the [[Resolve]] rating of the character targeted by the roll, with the chosen action succeeding or failing with the roll. However, in some cases there are further considerations before the action is fully resolved.
## Spending [[Willpower]]
