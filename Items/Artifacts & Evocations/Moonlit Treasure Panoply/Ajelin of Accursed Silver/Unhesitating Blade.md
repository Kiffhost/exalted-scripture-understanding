...
## Resonant
The wielder doubles her Enmity when determining if she can use this Evocation against an enemy.
## Dissonant
A successful attack can’t delay its target’s turn by more than (Enmity) ticks.

## Reset 
Once per scene, unless reset by crashing an enemy whose [[Initiative]] was higher than the wielder’s. She can’t reset it if she’s crashed.