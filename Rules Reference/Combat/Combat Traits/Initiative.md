Initiative is a very important element of combat. Initiative may be increased by [[Combat Actions#Attack#withering|withering attacks]], and spent on Charms and [[Combat Actions#Attack#decisive|decisive attacks]]. Starting initiative is determined each combat by a [[Join Battle]] roll.
...
- Cannot launch [[Combat Actions#Attack#decisive|decisive attacks]].
...
[[Combat Actions#Attack#withering|Withering attacks]] continue to affect a Crashed character as normal. However, if the Storyteller decides that a Crashed character has no hope of recovery and is being used as an easy source of initiative, they can declare he Crashed character defeated the next time they suffer a successful [[Combat Actions#Attack#withering|withering attack.]] 
