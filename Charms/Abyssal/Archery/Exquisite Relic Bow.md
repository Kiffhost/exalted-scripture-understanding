...
The deathknight can use Relic Arrow Method’s dice-adding effect to enhance attacks made with the summoned weapon without regard for its once-perscene limit, although each use beyond the first incurs a one-mote surcharge.
