...
The Abyssal makes an (Appearance + Performance) inspire roll over the course of a few minutes, adding (Essence) bonus dice. Affected characters suffer a −3 penalty on Perception rolls and Join Battle rolls and treat any Intimacies related to discipline, fear, or self-restraint as one step weaker for the rest of the scene.
