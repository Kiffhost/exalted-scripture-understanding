...
The Sidereal spends an hour training a battle group of up to Size (Intelligence). In its next battle, it gains −1 target number on Join Battle rolls, rout checks, and damage rolls against enemies of fate and crashed foes. This lasts one battle and is lost if not used within a week. Only one battle group can benefit at a time.
