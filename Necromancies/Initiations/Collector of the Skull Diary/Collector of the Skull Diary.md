...
```dataview
LIST
FROM "Necromancies/Initiations/Collector of the Skull Diary" AND #ShapingRitual
```
# Other Benefits
Necromancers with any of the [[#Shaping Rituals]] from this initiation may purchase the following [[Merits]]:
```dataview
LIST
FROM "Necromancies/Initiations/Collector of the Skull Diary" AND #merit/Purchased/Necromantic
```
