...
When the Abyssal makes an Awareness roll to detect a hidden enemy or other danger, she adds a non-Charm success. She gains one mote for each 9 she rolls and two motes for each 10. This can’t exceed the number of motes spent enhancing the roll.
