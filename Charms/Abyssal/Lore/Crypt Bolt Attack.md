...
The Abyssal makes a withering or decisive attack with a bolt of necrotic energy, rolling (Dexterity + {Archery or Thrown}) against an enemy within medium range.
It has the following traits
- The Accuracy of an artifact Archery weapon:
...
The Abyssal can enhance her attack with Archery or Thrown Charms but can’t combine Charms from the two Abilities.
