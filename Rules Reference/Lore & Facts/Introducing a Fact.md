...
# Admissibility
#advice/storyteller 
- Facts introduced in this manner must remain internally consistent. 
- Once a character has successfully introduced a fact, that information should not be contradicted.
	- Therefore, another player **cannot** then introduce a completely contradictory fact by rolling an even better result. 
- Once a fact about the setting has been introduced, it becomes concrete.
- Storyteller's may always ***veto*** and should for:
	- Contradictions of the setting history.
	- Contradictions of a fact in a future plot point.
	- Facts which the Storyteller is uncertain about (you can always allow them later).
	- Canonical information you think it would be impossible for the character to know.
