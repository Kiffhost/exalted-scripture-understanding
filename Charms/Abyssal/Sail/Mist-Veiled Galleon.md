...
The Abyssal shrouds her ship in fog, which extends out to medium range from the ship. It inflicts a −3 penalty on vision-based Perception rolls and a −1 penalty on other actions that depend on vision, including attacks.
This subtracts successes instead of dice on rolls to identify or track the ship. This mist can’t be dispersed by mundane wind or weather, though magic is capable of doing so.
