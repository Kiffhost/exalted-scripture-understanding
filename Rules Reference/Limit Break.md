...
- Each Virtue Flaw forces the character to act out some kind of behavior that is harmful to those around him or to himself. The behavior enforced by [[Limit Break]] is treated as a Defining [[Intimacy|Principle]], applying a +4 or -3 to the character’s [[Resolve]] against relevant influence rolls and allowing the character to treat certain types of influence as unacceptable.
