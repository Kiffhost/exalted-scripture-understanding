...
However, Lookshy’s store of gunzosha armor is too small to allow every field force to have a full gunzosha complement; the Stores Directorate and the Directorate of the Adjutant-General coordinate unit allocation. The Stores Directorate is keenly aware of gunzosha armor’s irreplaceability and is loath to deploy gunzosha in circumstances where a fallen warrior’s armor might not be retrievable.
...
# BECOMING A GUNZOSHA
Creating the jade amulets necessary for a mortal to attune to gunzosha armor is a major project (Exalted, p. 240) that requires [[Craft]] ([[Artifact]]). Surgically implanting them is a difficulty 3 ([[Intelligence]] + [[Medicine]]) roll that inflicts a level of unpreventable lethal damage.
# GUNZOSHA AND RESONANCE 
For artifacts such as gunzosha armor that allow mortals to attune them, mortal wielders are considered dissonant regardless of the materials the artifact is made from.