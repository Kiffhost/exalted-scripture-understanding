It's how you do things. Most actions take 1 [[Time#Round]] in combat.
# Extended
...
# Opposed
When two characters attempt actions that can only result in one of them winning, each player makes a [[Dice Roll|dice roll]] with no difficulty. The player with the most [[Dice Rolls#Successes|successes]] wins. In the case of a tie, the Storyteller awards victory to the player with the best stunt.
# Reflexive
