...
In the case of feats of strength to destroy an object, using a tool that would logically assist adds 1 automatic success to the attempt. If the tool is an artifact weapon, add 2. 

In combat, it’s generally a good idea to ignore these rules and allow characters to use [[Stunt|stunts]] to automatically break things, as long as those things aren’t tactically significant to the battle or important to the story, and so long as it’s within the scope of what the character might be able to accomplish. Also, you can allow feats of strength to automatically succeed if the character’s dice pool is three times the difficulty or more.
...
#custom/note: I think this chart is kinda bad.