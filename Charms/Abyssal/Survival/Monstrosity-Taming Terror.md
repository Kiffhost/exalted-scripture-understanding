...
The Abyssal adds (Essence) automatic successes on a roll to train an animal (Exalted, p. 554) and shortens the interval to one week. She waives the usual specialty requirements. While using Superior Predator Style, she ignores penalties for working with wild or hostile animals.
