...
## Reset
This Charm can only be used on a given character once per session.
## [[Keys]]
#### Psychic Scalpel Vivisection (Essence 3) (+6m)
The Infernal can pay a six-mote surcharge to ask an additional question or learn an additional Intimacy for each extra success on the roll. Her victim forgets the experience of being probed unless he spent at least one Willpower resisting it.