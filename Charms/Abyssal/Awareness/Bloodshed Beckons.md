...
For each failed die that’s rerolled into a success, the Abyssal banks one automatic success. For the rest of the scene, she can add these banked successes on any Awareness rolls she makes opposing an enemy’s Stealth.
