...
Once the Abyssal has introduced such a fact, she can use this Charm to add (Intimacy) non-Charm dice on a social and mental action with any Ability that exploits the revealed weakness. This isn’t compatible with attacks, Shape Sorcery rolls, or extended actions.
