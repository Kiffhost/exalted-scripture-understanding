...
With a Performance 4 repurchase, the Abyssal can use this Charm on a performance that she watches. Doing so lets the performer use the deathknight’s Appearance instead of his own if the rest of the audience can see the Abyssal.
