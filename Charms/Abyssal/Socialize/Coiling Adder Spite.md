...
When the Abyssal cites a negative Tie in a Decision Point, she treats its intensity as one step higher. If it’s already Defining, the Willpower cost to resist the influence is reduced by (Essence).
The deathknight can also increase a negative Tie’s rating when she uses an instant-duration Abyssal Charm that specifically relies on negative Ties. If her Tie is already Defining, add (Essence) non-Charm dice on any roll made as part of that Charm.
