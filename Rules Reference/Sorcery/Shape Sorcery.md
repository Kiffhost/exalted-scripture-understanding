...
2. Roll (Intelligence + Occult), this counts as a [[Combat Action]], and cannot be [[Flurry|flurried]]. 
	1. Each success contributes 1 [[Sorcery#Motes|sorcerous mote]] to the casting of the spell. ^d9f282
...
```
Each archetype is associated with a number of *shaping rituals*, which provide instructions and conditions as to how a character might gain [[Sorcery#Motes|sorcerous motes]].
## Reflexive Rituals
